...
public class DriveConstants {
    ...
    // public static double GEAR_RATIO = 1.02885; // output (wheel) speed / input (motor) speed
    // public static double TRACK_WIDTH = 11.58; // in
    public static double WHEEL_RADIUS = 1.8898; // in
    public static double GEAR_RATIO = 1.0152; // output (wheel) speed / input (motor) speed
    ...
    public static double MAX_ANG_VEL = Math.toRadians(322);
    public static double MAX_ANG_ACCEL = Math.toRadians(322);
