...
import org.firstinspires.ftc.teamcode.reee.DriveReee;

import java.util.ArrayList;

@TeleOp(name = "Reeeeee TeleOp")
public class TeleopReee extends OpMode {

    private DriveReee drive;
    private Gyro gyro;
    ...
    @Override
    public void init() {
        drive = new DriveReee(this, hardwareMap);
