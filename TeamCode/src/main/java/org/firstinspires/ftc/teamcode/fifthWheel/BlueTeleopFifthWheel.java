...
@TeleOp(name = "FifthWheel Blue TeleOp")
public class BlueTeleopFifthWheel extends OpMode {
    ...
    public void init() {
        ...
        place = new Place(hardwareMap, "liftLeft", "liftRight", "touch", "flipLeft", "flipRight", "grip", Gripper.Alliance.BLUE);
